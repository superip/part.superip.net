	...
	<table class="table xs-full mb-4"> <!-- table-striped table-hover  -->
		<thead>
			<tr class="d-none d-md-table-row">
				...
				<th>제목</th>
				<th class="d-none d-md-table-cell" style="width: 7rem;">담당자</th>
				<th class="d-none d-md-table-cell" style="width: 7rem;">P/N</th>
				...
				<th class="d-none d-md-table-cell" style="width: 7rem;">요청일</th>
			</tr>
		</thead>
		<tbody>
			<?php 
			...
			<tr class="<?php if($list[$i]['is_notice']) echo "table-primary"; ?>">
				...
				<td class="d-none d-md-table-cell">
					<!--img class="list-icon rounded" src="<?php echo $mb_info['img'] ?>"--> 
					<div class="dropdown d-inline">
						<a href="#" data-bs-toggle="dropdown" class="text-dark"><?php echo get_text($list[$i]['wr_9']); ?></a>
						<?php echo $mb_info['menu'] ?>
					</div>
				</td>
				<td class="d-none d-md-table-cell"><?php echo $list[$i]['wr_4'] ?></td>
				...
				<td class="d-none d-md-table-cell"><?php echo $list[$i]['wr_1'] ?></td>
			</tr>
			<?php } ?>
...
function fboardlist_submit(f) {
    ...
    if(document.pressed == "선택주문") {
        var sub_win = window.open("", "move", "left=50, top=50, width=500, height=550, scrollbars=1");
		f.target = "move";
		f.action = "/bbs/formmail.php?mb_id=jinhan2&name=%EC%8A%88%ED%8D%BC%EC%95%84%EC%9D%B4%ED%94%BC&email=pa2mmtOfoKaczseiz2HJpp8-"; 
        return;
    }
