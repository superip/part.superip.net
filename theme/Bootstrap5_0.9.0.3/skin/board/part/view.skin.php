...
<div>
		...
		<tbody>
			<tr>
				<td>
					...
					<ul class="list-inline small text-muted mt-1 mb-0 d-md-none">
						<li class="list-inline-item" style="width:11%">요청일</li>
						<li class="list-inline-item" style="width:32%"><?php echo $view['wr_1']; ?></li>
						<li class="list-inline-item" style="width:11%">종류</li>
						<li class="list-inline-item" style="width:32%"><?php echo $view['wr_2']; ?></li>
					</ul>
				</td>
				<td class="d-none d-md-table-cell">요청일</td>
				<td class="d-none d-md-table-cell"><?php echo $view['wr_1']; ?></td>
				<td class="d-none d-md-table-cell">종류</td>
				<td class="d-none d-md-table-cell"><?php echo $view['wr_2']; ?></td>
			</tr>
			<tr>
				<td>
					<!-- 모바일 -->
					<ul class="list-inline small text-muted mt-1 mb-0 d-md-none">
						<li class="list-inline-item" style="width:11%">파트명</li>
						<li class="list-inline-item" style="width:32%"><?php echo $view['wr_3']; ?></li>
						<li class="list-inline-item" style="width:11%">P/N</li>
						<li class="list-inline-item" style="width:32%"><?php echo $view['wr_4']; ?></li>
					</ul>
				</td>
				<td class="d-none d-md-table-cell">파트명</td>
				<td class="d-none d-md-table-cell"><?php echo $view['wr_3']; ?></td>
				<td class="d-none d-md-table-cell">P/N</td>
				<td class="d-none d-md-table-cell"><?php echo $view['wr_4']; ?></td>
			</tr>
			<tr>
				<td>
					<!-- 모바일 -->
					<ul class="list-inline small text-muted mt-1 mb-0 d-md-none">
						<li class="list-inline-item" style="width:11%">호스명</li>
						<li class="list-inline-item" style="width:32%"><?php echo $view['wr_5']; ?></li>
						<li class="list-inline-item" style="width:11%">업무명</li>
						<li class="list-inline-item" style="width:32%"><?php echo $view['wr_8']; ?></li>
					</ul>
				</td>
				<td class="d-none d-md-table-cell">호스트명</td>
				<td class="d-none d-md-table-cell"><?php echo $view['wr_5']; ?></td>
				<td class="d-none d-md-table-cell">업무명</td>
				<td class="d-none d-md-table-cell"><?php echo $view['wr_8']; ?></td>
			</tr>
			...
			<tr>
				<td>
					<!-- 모바일 -->
					<ul class="list-inline small text-muted mt-1 mb-0 d-md-none">
						<li class="list-inline-item" style="width:11%">모델명</li>
						<li class="list-inline-item" style="width:32%"><?php echo $view['wr_6']; ?></li>
						<li class="list-inline-item" style="width:11%">S/N</li>
						<li class="list-inline-item" style="width:32%"><?php echo $view['wr_7']; ?></li>
					</ul>
				</td>
				<td class="d-none d-md-table-cell">모델명</td>
				<td class="d-none d-md-table-cell"><?php echo $view['wr_6']; ?></td>
				<td class="d-none d-md-table-cell">S/N</td>
				<td class="d-none d-md-table-cell"><?php echo $view['wr_7']; ?></td>
			</tr>
		</tbody>
	</table>
    ...
    <?php 
 $data = $view['wr_1']."|".$view['wr_2']."|".$view['wr_3']."|".$view['wr_4']."|".$view['wr_6'];
// 기존 받는 메일 소스
 $email_enc = new str_encrypt();
 $email = $email_enc->encrypt("jinhan2@dbinc.co.kr");
 $id = "master";
 $name = "관리자";
?>
	...
	<div class="d-flex flex-sm-row flex-column justify-content-sm-between mb-4">
		<div class="d-flex justify-content-center mb-2 mb-sm-0">
			...
			<div class="btn-group xs-100">
			    ...
			    <a href="<?php echo G5_BBS_URL ?>/formmail.php?mb_id=<?php echo $id; ?>&name=<?php echo urlencode($name);?>&email=<?php echo $email;?>&wr_data=<?php echo $data?> " onclick="win_memo(this.href); return false;" target="_blank" class="btn btn-danger">
				<i class="fa fa-rocket"></i>주문</a>
			</div>
			<?php } ?>
		</div>
