...
$wr_cont =explode("|", $_REQUEST['wr_data']);
if ($wr_cont[1]!="") {
    $wr_subject = "[DBInc][$wr_cont[1]] $wr_cont[2]";
} else {
    $wr_subject = "";
}
if($wr_cont[3] != "") {
	$wr_subject.="($wr_cont[3])";
}
$wr_content = "";
if ($wr_cont[0]!="") { $wr_content .= "요청일 : $wr_cont[0] \n"; }
if ($wr_cont[1]!="") { $wr_content.= "파트종류 : $wr_cont[1] \n"; }
if ($wr_cont[2]!="") {$wr_content.= "파트명 : $wr_cont[2] \n"; }
if ($wr_cont[3]!="") {$wr_content.= "파트번호 : $wr_cont[3] \n"; }
if ($wr_cont[4]!="") {$wr_content.= "서버모델 : $wr_cont[4] \n"; }
    ...
    <div class="form_01 new_win_con">
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" name="subject" id="subject" required class="frm_input full_input required"  placeholder="제목" value="<?php echo $wr_subject;?>">
            </li>
            <li class="chk_box">
            ...
            <li>
                ...
                <textarea name="content" id="content" required class="required"><?php echo $wr_content; ?></textarea>
            </li>
